                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('lojas.index') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.restaurants.store') }}" autocomplete="off">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="form-group d-none">
                                        ...
                                        <input type="number" name="loja" id="loja" class="form-control form-control-alternative" value="99999">
                                    </div>
                                <div class="form-group d-none"> 
                                    <input name="users" id="users" value="<?php echo Auth::user()->id; ?>">
                                </div>
                                </div>
                                <hr />
