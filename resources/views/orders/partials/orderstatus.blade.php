            ...
            <div class="timeline-content">
                <div class="d-flex justify-content-between pt-1">
                    ...
                    <div class="text-right">
                        <small class="text-muted"><i class="fas fa-clock mr-1"></i>{{ $stakeholder->pivot->created_at->setTimezone('America/Sao_Paulo')->format(config('settings.datetime_display_format')) }}</small>
                    </div>
                </div>
