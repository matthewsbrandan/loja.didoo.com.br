                        ...
                        <form role="form" method="post" action="{{ route('items.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-center{{ $errors->has('item_image') ? ' has-danger' : '' }}">
                                ...
                                <div class="text-center">
                                    ...
                                    <div>
                                    <div class="preview-more-images"></div>
                                    <span class="btn btn-outline-secondary btn-file">
                                    <span class="fileinput-new">{{ __('Select image') }}</span>
                                    <span class="fileinput-exists">{{ __('Change') }}</span>
                                        <input type="file" name="item_image[]" accept="image/x-png,image/gif,image/jpeg" multiple onchange="handleMultipleImages(event);">
                                    </span>
