                        ...
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('admin.restaurants.store') }}" autocomplete="off">
                                ...
                                <div class="form-group d-none">
                                    ...
                                    <input type="number" name="loja" id="loja" class="form-control form-control-alternative" value="22222">
                                </div>
                        
                                <div class="form-group">
                                    <?php 
                                        $dados = \App\User::where(['loja' => 1 ])->get();
                                    ?>
                                    <label class="form-control-label" for="loja">{{ __('Franquia') }}</label>
                                    <select name="users" id="users" class="form-control form-control-alternative">
                                        <?php foreach($dados as $v){ ?>
                                            <option value="<?= $v->id; ?>"><?= $v->franquia; ?></option>
                                        <?php } ?>
                                    </select>  
