        ...
        <div class="row">
            <div class="col-xl-6">
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                ...
                                @if (config('settings.wildcard_domain_ready'))
                                    <a target="_blank" href="{{ $restorant->getLinkAttribute() }}" class="btn btn-sm btn-success">{{ __('VEJA A LOJA') }}</a>
                                @else
                                    <a target="_blank" href="{{ route('vendor',$restorant->subdomain) }}" class="btn btn-sm btn-success">{{ __('VEJA A LOJA') }}</a>
                                @endif
                ...
                <div class="col-xl-6 mb-5 mb-xl-0">
                    ...
                    <br/>
                    @include('restorants.partials.tax')
...
<script async defer src= "https://maps.googleapis.com/maps/api/js?libraries=geometry,drawing&key=<?php echo config('settings.google_maps_api_key'); ?>"> </script>
    ...
    <script type="text/javascript">
        ...
        // BEGIN:: HANDLE WHATSAPP PHONE
        $(function(){
            $('#whatsapp_phone').on('keyup', function() {
                let phone = $('#whatsapp_phone').val();
                if(phone.length >= 10){
                    if(phone.substr(0,3) != "+55"){
                        $('#whatsapp_phone').val("+55"+phone);
                    }
                }
            });
        })
        //END:: HANDLE WHATSAPP PHONE
    </script>
@endsection
