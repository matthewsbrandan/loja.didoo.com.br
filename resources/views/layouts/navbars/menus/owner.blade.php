<ul class="navbar-nav">
    ...
    @endif
    <?php
    $dados = \App\User::where(['id' => Auth::user()->id])->first();
    if($dados->loja == 1){
    ?>
    <li class="nav-item">
        <a class="nav-link" href="/lojas">
            <i class="fas fa-shopping-basket text-info"></i> {{ __('Minhas Lojas') }}
        </a>
    </li>
    <?php } else {?>
    ...
    <li class="nav-item">
            <a class="nav-link" href="{{ route('share.menu') }}">
                <i class="ni ni-users"></i> {{ __('Clientes') }}
            </a>
    </li>
    <li class="nav-item">
            <a class="nav-link" href="{{ route('share.menu') }}">
                <i class="ni ni-car"></i> {{ __('Entregadores') }}
            </a>
    </li>
    <li class="nav-item">
            <a class="nav-link" href="{{ route('share.menu') }}">
                <i class="ni ni-star"></i> {{ __('Avaliações') }}
            </a>
    </li>
