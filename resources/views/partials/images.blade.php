<div class="form-group text-center">
    <label class="form-control-label" for="input-name"><?php if($image['label'] == "Imagem da Loja"){ echo "LOGO DA SUA LOJA"; } elseif ($image['label'] == "Imagem de capa da loja") { echo "BANNER FUNDO"; }else{ echo $image['label']; } ?> </label>
    @isset($image['help'])
