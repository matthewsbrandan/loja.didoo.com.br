...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('restaurant/tax', 'RestorantController@tax')->name('restaurant.tax');
    Route::get('restaurant/tax/{rid}', 'RestorantController@toggleTax')->name('restaurant.untax');
    ...
    Route::name('admin.')->group(function () {
        ...
        Route::get('stores/loginas/{restaurant}', 'RestorantController@loginas')->name('restaurants.loginas');
        ...
        Route::name('restaurant.')->group(function () {
            ...
            //Remove restaurant
            Route::get('removestore/{restaurant}', 'RestorantController@remove')->name('remove');
    ...
    //Route::resource('franquias/create', 'FranquiasController@create')->name('franquias.create');
    ...
    Route::post('/import/stores', 'RestorantController@import')->name('import.restaurants');
    Route::get('/store/{restaurant}/activate', 'RestorantController@activateRestaurant')->name('restaurant.activate');
    Route::post('/store/workinghours', 'RestorantController@workingHours')->name('restaurant.workinghours');
...
Route::get('/finish-cart/{restorant_id}', 'OrderController@redirectToWhatsapp')->name('redirectToWhatsapp');
...
Route::get('/new/store/register', 'RestorantController@showRegisterRestaurant')->name('newrestaurant.register');
Route::post('/new/store/register/store', 'RestorantController@storeRegisterRestaurant')->name('newrestaurant.store');
