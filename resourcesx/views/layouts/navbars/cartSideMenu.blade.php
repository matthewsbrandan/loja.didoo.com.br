        ...
        <div class="minicart-content">
            ...
            <div class="searchable-container">
                ...
                <div id="totalPrices" v-cloak>
                    ...
                    <div data-toggle="modal" data-target="#modal-scheduling">
                        <a  class="btn  bg-light text-white">AGENDAR PARA OUTRA DATA</a>
                    </div>
                    <br/>
                    <div v-if="totalPrice" v-cloak class="text-center mobile-menu">
                        <a type="button" class="btn  bg-light text-white btn-sm" style="text-transform:none; font-size:18px" onclick="closeNav()">{{ __('Continue Shopping') }}</a>
                    </div>
                    <br>
                    <div v-if="totalPrice" v-cloak>
                        <a 
                            href="/cart-checkout" class="btn  text-white"
                            style="background-color: #D9D375"
                            >{{ __('Checkout') }}
                        </a>
                    </div>
                    <br>
