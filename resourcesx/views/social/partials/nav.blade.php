    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navbar_global">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
            ...
            <li class="nav-item dropdown">
              <a href="#" class="nav-link" data-toggle="dropdown" role="button">
                ...
                @foreach ($availableLanguages as $short => $lang)
                  @if(strtolower($short) == strtolower($locale))<span class="nav-link-inner--text">{{ $lang == 'Portuguese' ? 'Português' : $lang }}</span>@endif
                @endforeach
              </a>
              <div class="dropdown-menu">
                @foreach ($availableLanguages as $short => $lang)
                  <a href="/{{ strtolower($short) }}" class="dropdown-item">{{ $lang == 'Portuguese' ? 'Português' : $lang }}</a>
                @endforeach
              </div>
            </li>
          @endif
          ...
          @guest()
          <li class="nav-item d-none d-lg-block ml-lg-2">
            <a class="btn btn-neutral btn-icon" href="{{ route('newrestaurant.register') }}" target="_blank">
              <span class="btn-inner--icon">
